...
SCRIPT = Path(__file__).resolve().parents[1] / "verify_acceptance_2_1_5.py"
SPEC = importlib.util.spec_from_file_location("verify_acceptance_2_1_5", SCRIPT)
...
def base_manifest() -> dict:
    return {
        ...
        "evidence_root": "work/qa-2.1.5/evidence",
        "artifact": {},
        "cases": [
            {
                "id": "PRE-01",
...
class AcceptanceVerifierTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.manifest = self.root / "qa" / "2.1.5" / "acceptance.json"
        self.manifest.parent.mkdir(parents=True)
        self.evidence_root = self.root / "work" / "qa-2.1.5" / "evidence"
    ...
    def test_final_phase_includes_postpublication_cases(self) -> None:
        ...
        data["artifact"] = {
            "iso_path": "shadowfetch-2.1.5-amd64.iso",
            "iso_sha256": "a" * 64,
            "iso_size_bytes": 1,
            "signature_path": "shadowfetch-2.1.5-amd64.iso.asc",
            "signing_fingerprint": "8F13CE1535EE1F4A2916A1F73C5C900B7BE80CA1",
            "evidence_bundle_path": "shadowfetch-2.1.5-qa.tar.zst",
