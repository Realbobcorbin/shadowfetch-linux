#!/usr/bin/env python3
"""Validate Shadowfetch Linux 2.1.5 packages and signed APT repository."""
...
EXPECTED_BINARIES = {
    "grub-btrfs": "4.14-2",
    "shadowfetch-branding": "2.1.5-1",
    "shadowfetch-control-center": "2.1.5-1",
    "shadowfetch-creative-base": "2.1.5-1",
    "shadowfetch-defaults": "2.1.5-1",
    "shadowfetch-desktop": "2.1.5-1",
    "shadowfetch-ember": "2.1.5-1",
    "shadowfetch-fireproof": "2.1.5-1",
    "shadowfetch-firewatchd": "2.1.5-1",
    "shadowfetch-hwscan": "2.1.5-1",
    "shadowfetch-menus": "2.1.5-1",
    "shadowfetch-nvidia": "2.1.5-1",
    "shadowfetch-phoenix": "2.1.5-1",
    "shadowfetch-themes": "2.1.5-1",
    "shadowfetch-welcome": "2.1.5-1",
}
EXPECTED_SOURCES = {
    "grub-btrfs",
