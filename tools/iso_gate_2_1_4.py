#!/usr/bin/env python3
"""Validate the final Shadowfetch Linux 2.1.4 ISO as a release artifact."""
...
def payload_gate(squashfs: Path, inventory: dict[str, str]) -> None:
    ...
    assert isinstance(compose, str) and isinstance(helper, str) and isinstance(service, str)
